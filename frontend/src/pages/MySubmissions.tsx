                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {submissions.map((submission) => (
                                        <tr key={submission.id} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <span className="text-sm text-gray-700">{submission.course_name}</span>
                                            </td>
                                            <td className="px-6 py-4 whitespace-nowrap">
            ...
            {verificationModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
                        <h2 className="text-2xl font-bold text-gray-800 mb-4">Digital Signature Verification</h2>

                        {verifying ? (
                            <div className="text-center py-8">
                                <div className="text-gray-600">Verifying signature...</div>
                            </div>
                        ) : verificationResult ? (
                            <div>
                                    ...
                                    <div className="bg-green-50 border-2 border-green-200 rounded-lg p-6 mb-4">
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-green-700">Signature verified successfully</p>
                                            </div>
                                        </div>
                                    </div>
                                ) : (
                                    <div className="bg-red-50 border-2 border-red-200 rounded-lg p-6 mb-4">
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-red-700">Signature verification failed</p>
                                            </div>
                                        </div>
                                    </div>
                                )}
                                ...
                                <div className="space-y-3">
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        <div className="text-sm font-medium text-gray-600 mb-1">Graded By:</div>
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        <div className="text-sm font-medium text-gray-600 mb-1">File Hash (SHA-256):</div>
